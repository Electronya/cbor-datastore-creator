...
class TestIntArray(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._arrayElements = [
            IntArrayElement(-255, 100, 32),
            IntArrayElement(-50, 255, 50),
            IntArrayElement(-25, 75, 32),
        ]
    ...
    def test__isElementValid(self) -> None:
        ...
        for values in testValues:
            ...
            self.assertEqual(values[3], self._uut
                             ._isElementValid(IntArrayElement(values[0],
                                                              values[1],
                                                              values[2])))
    ...
    def test_getElementCount(self) -> None:
        ...
        elements = [IntArrayElement(10, 30, 15), IntArrayElement(0, 255, 4)]
    ...
    def test_appendElementRaiseElementError(self) -> None:
        ...
        element is invalid.
        """
        element = IntArrayElement(-1 * pow(2, 32) - 1, 10, 5)
    ...
    def test_appendElementAppendNewElement(self) -> None:
        ...
        element = IntArrayElement(0, 10, 5)
        self._uut.appendElement(element)
    ...
    def test_removeElementRaiseValueError(self) -> None:
        ...
        not in the array.
        """
        element = IntArrayElement(0, 15, 3)
